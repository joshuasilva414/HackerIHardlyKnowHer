  ...
  return (
    <div className="Landing">
      ...
      <main className="min-h-screen">
        <div className="flex justify-evenly border-solid border-4 border-rh-space-blue">
          ...
          <div className="flex-1 borderbox w-1/2 h-96 border-solid border-4 border-rh-space-blue">
            <div className="flex-none">
              <h1 className="font-serif text-rh-ocean-blue text-center text-4xl font-bold mx-auto mt-14 mb-3 py-4 px-2 border-box w-1/2 h-23 border-solid border-2 border-rh-ocean-blue rounded-3xl bg-rh-sunset">
                Rosetta News
              </h1>
            </div>
            <div className="flex flex-col">
              <p className="m-auto text-center border-box w-1/2 h-32 text-xl font-bold">
                Welcome to Rosetta News, an AI tool built for News Collection
                and Translation for instant analyzation. Try it out below:
              </p>
              <a
                href="/app"
                class="
        ...
        <div className="border-box w-full h-96 border-solid border-4 border-rh-space-blue font-bold">
          ...
          <div className="text-2xl text-left mx-24 my-16">
            <p>
              Here we will cover details about the project, its potential uses,
              what we could expand upon, etc.
            </p>
          </div>
        </div>
        {/* End of Summary */}
        ...
        <div
          id="faq"
          className="border-box w-full h-96 border-solid border-4 border-rh-space-blue font-bold"
        >
          <div className="text-4xl text-left ml-16 mt-8 mb-4">FAQ</div>
      ...
      <footer>
        <div
          id="credits"
          className="bg-rh-white w-full h-16 border-solid border-4 border-rh-space-blue"
        >
